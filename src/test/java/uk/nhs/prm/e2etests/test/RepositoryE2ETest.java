...
class RepositoryE2ETest {
    ...
    public RepositoryE2ETest(
        ...
        repositoryOdsCode = nhsProperties.getRepoOdsCode();
    }
     ...
     *
     ...
     For readability's sake, it is easiest to set up test so that sender & recipient are the same practice
