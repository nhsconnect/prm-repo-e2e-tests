...
public class EhrCompleteQueue extends QueueMessageHelper {
    ...
    @Autowired
    public EhrCompleteQueue(ThinlyWrappedSqsClient thinlyWrappedSqsClient, TestConfiguration configuration) {
        super(thinlyWrappedSqsClient, configuration.ehrCompleteQueueUri());
    }
}
