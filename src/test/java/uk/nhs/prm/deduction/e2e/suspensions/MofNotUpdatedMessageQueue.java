...
public class MofNotUpdatedMessageQueue extends QueueMessageHelper {
    @Autowired
    public MofNotUpdatedMessageQueue(ThinlyWrappedSqsClient thinlyWrappedSqsClient, TestConfiguration configuration) {
        super(thinlyWrappedSqsClient, configuration.mofNotUpdatedQueueUri());
    }
}
