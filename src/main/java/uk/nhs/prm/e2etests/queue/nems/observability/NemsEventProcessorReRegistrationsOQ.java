...
public class NemsEventProcessorReRegistrationsOQ extends AbstractNemsEventMessageQueue {
    ...
    @PostConstruct
    public void init() {
        this.sqsService.createQueue(this.queueProperties.getNemsEventProcessorReregistrationObservabilityQueueName());
        this.snsService.subscribeQueueToTopic(
                this.queueProperties.getNemsEventProcessorReregistrationObservabilityQueueArn(),
                this.topicProperties.getNemsEventProcessorRegistrationTopicArn());
    }

    @PreDestroy
    public void cleanUp() {
        this.sqsService.deleteQueue(this.queueProperties.getNemsEventProcessorReregistrationObservabilityQueueUrl());
    }
}